...
public static class DataGenerator
{
    ...
    public static List<Flight> GenerateFlights(List<AircraftModel> models)
    {
        ...
        {
            new Flight { Id = 1, Code = "SU1001", DeparturePoint = "Moscow", ArrivalPoint = "St. Petersburg", DepartureDate = new DateTime(2024, 1, 15), ArrivalDate = new DateTime(2024, 1, 15), Duration = new TimeSpan(1, 30, 0), AircraftModelId = model1.Id, AircraftModel = model1 },
            new Flight { Id = 2, Code = "SU1002", DeparturePoint = "Moscow", ArrivalPoint = "St. Petersburg", DepartureDate = new DateTime(2024, 1, 15), ArrivalDate = new DateTime(2024, 1, 15), Duration = new TimeSpan(1, 25, 0), AircraftModelId = model2.Id, AircraftModel = model2 },
            new Flight { Id = 3, Code = "SU2001", DeparturePoint = "Moscow", ArrivalPoint = "Sochi", DepartureDate = new DateTime(2024, 1, 16), ArrivalDate = new DateTime(2024, 1, 16), Duration = new TimeSpan(2, 30, 0), AircraftModelId = model3.Id, AircraftModel = model3 },
            new Flight { Id = 4, Code = "SU3001", DeparturePoint = "Moscow", ArrivalPoint = "New York", DepartureDate = new DateTime(2024, 1, 17), ArrivalDate = new DateTime(2024, 1, 17), Duration = new TimeSpan(10, 45, 0), AircraftModelId = model4.Id, AircraftModel = model4 },
            new Flight { Id = 5, Code = "SU4001", DeparturePoint = "Moscow", ArrivalPoint = "Tokyo", DepartureDate = new DateTime(2024, 1, 18), ArrivalDate = new DateTime(2024, 1, 18), Duration = new TimeSpan(9, 30, 0), AircraftModelId = model5.Id, AircraftModel = model5 },
            new Flight { Id = 6, Code = "SU5001", DeparturePoint = "St. Petersburg", ArrivalPoint = "Helsinki", DepartureDate = new DateTime(2024, 1, 19), ArrivalDate = new DateTime(2024, 1, 19), Duration = new TimeSpan(1, 0, 0), AircraftModelId = model6.Id, AircraftModel = model6 },
            new Flight { Id = 7, Code = "SU5002", DeparturePoint = "St. Petersburg", ArrivalPoint = "Helsinki", DepartureDate = new DateTime(2024, 1, 19), ArrivalDate = new DateTime(2024, 1, 19), Duration = new TimeSpan(1, 5, 0), AircraftModelId = model7.Id, AircraftModel = model7 },
            new Flight { Id = 8, Code = "SU6001", DeparturePoint = "Sochi", ArrivalPoint = "Moscow", DepartureDate = new DateTime(2024, 1, 20), ArrivalDate = new DateTime(2024, 1, 20), Duration = new TimeSpan(2, 25, 0), AircraftModelId = model8.Id, AircraftModel = model8 },
            new Flight { Id = 9, Code = "SU7001", DeparturePoint = "New York", ArrivalPoint = "Moscow", DepartureDate = new DateTime(2024, 1, 21), ArrivalDate = new DateTime(2024, 1, 21), Duration = new TimeSpan(10, 30, 0), AircraftModelId = model9.Id, AircraftModel = model9 },
            new Flight { Id = 10, Code = "SU8001", DeparturePoint = "Tokyo", ArrivalPoint = "Moscow", DepartureDate = new DateTime(2024, 1, 22), ArrivalDate = new DateTime(2024, 1, 22), Duration = new TimeSpan(9, 45, 0), AircraftModelId = model10.Id, AircraftModel = model10 }
        };
    }
